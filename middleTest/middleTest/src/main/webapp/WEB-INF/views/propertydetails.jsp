			...
			<div class="col-lg-8">
				...
				<div class="card bg-light">
					<div class="card-body">
						...
						<div>
							<br />
							<h5 class="card-subtitle mb-2 text-muted">매물번호 : 333432</h5>
							<br />
						...
						<div class="mt-3">
							...
							<p class="card-text">넓은 거실과 화려한 전망이 있는 아파트입니다. 매우 조용한 주거 지역이며
								주변에는 편의시설이 많이 있습니다.</p>
						</div>
			...
			<div class="col-lg-4">
				<div class="card bg-light mt-4">
					<div class="card-body">
						...
						<hr>
						<button type="button" class="btn btn-primary btn-block">관심
							매물 등록</button>
					</div>
				</div>
