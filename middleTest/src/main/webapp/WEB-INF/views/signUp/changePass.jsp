			...
			<article class="card-body mx-auto" style="max-width: 400px;">
				...
				<form action="updatePass" class="changePass" method="post" enctype="multipart/form-data" >
					<table>
						...
						<tr>
							<td><b>비밀번호 확인</b></td>
							<td><input type="text" id="changeNewPassChk" class="changeNewPass" name="changeNewPassChk" placeholder="위의 입력값과 동일하게" pattern="[A-Za-z0-9]{2,15}" ></td>
						</tr>
					</table><hr>
				<div class="d-grid gap-2 col-6 mx-auto">
					<button type="button" class="btn btn-primary" id="changeAccountPass" name="changeAccountPass"> Change PW </button>
				</div>
				</form>
			</article>
